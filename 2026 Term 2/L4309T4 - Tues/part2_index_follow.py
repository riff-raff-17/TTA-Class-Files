...
from hand_common import(
    make_detector, INDEX_TIP, THUMB_TIP, FPSCounter
)
...
# Distance between thumb tip and index tip (in normalized units) below
...
def main()
    ...
    while running:
        ...
        if result.hand_landmarks:
            ...
            cv2.circle(
                frame, (int(index_tip.x * img_w), int(index_tip.y * img_h)), 8, (0, 255, 0), -1,
            )
        else:
            is_pinching = False
