...
from hand_common import (
    make_detector, draw_hand, draw_landmark_indices, draw_data_panel, FPSCounter,
)
...
def main():
    ...
    while True:
        ...
        fps_counter.tick()
        cv2.putText(frame, f"FPS: {fps_counter.get_fps():.0f}", (img_w -90, 24),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 255, 0), 2, cv2.LINE_AA)
        cv2.putText(frame, "[Q] quit   [L] landmarks   [D] data", (10, img_h - 10),
