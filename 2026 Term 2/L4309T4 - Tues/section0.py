...
# ---------------------------------------------------------------------------
# The landmark map — 21 points, always in this order
# ---------------------------------------------------------------------------
#
...
def mode_raw_numbers(frame, lms, w, h):
    ...
    panel_x, panel_y, line_h = w - 310, 20, 17
...
def mode_spotlight(frame, lms, w, h):
    ...
    label(frame, f"x = {lm.x:.4f}  (0=left,  1=right)", (14, 50), scale=0.4)
    label(frame, f"y = {lm.y:.4f}  (0=top,   1=bottom)", (14, 65), scale=0.4)
    label(frame, f"z = {lm.z:+.4f}  (neg = closer to cam)", (14, 80), scale=0.4)
