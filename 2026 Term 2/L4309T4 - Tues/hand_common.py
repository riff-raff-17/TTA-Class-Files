...
if not os.path.exists(MODEL_PATH):
    print(f"[hand common] Downloading model to '{MODEL_PATH}'...")
    urllib.request.urlretrieve(MODEL_URL, MODEL_PATH)
    print("[hand_common] Download complete.\n")

    # Landmark index constants

# 21 landmarks per hand, (x, y, z) each, normalised 01.
...
def make_detector(num_hands=2):
    """Create and return and HandLandmarker detector."""
