...
# Distance between the thumb tip and index tip (in normalised units) below
...
def main():
    ...
    pygame.display.set_caption("Hand-Controlled Character")
    ...
    while running:
        ...
        if result.hand_landmarks:
            ...
            # Draw the fungertip on the webcam preview
            cv2.circle(
                frame,
