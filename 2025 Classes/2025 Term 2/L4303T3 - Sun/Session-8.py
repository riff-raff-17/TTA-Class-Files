...
class Car(pygame.sprite.Sprite):
    ...
    def drive(self):
        self.rect.center += self.vel_vector * 6 # driving speed
    ...
    def collision(self):
        ...
        if SCREEN.get_at(collision_point_right) == GRASS_COLOR or SCREEN.get_at(collision_point_left) == GRASS_COLOR:
            self.alive = False
    ...
    def radar(self, radar_angle):
        ...
        while not SCREEN.get_at((x, y)) == GRASS_COLOR and length < 200:
            length += 1
